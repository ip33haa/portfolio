...
export const journey: JourneyScene[] = [
  ...
  },
  {
    ...
    body: "Early roles and foundations.\n\nI started as a developer, learning, experimenting, and building my foundation in web technologies. Each project taught me something new and sharpened my skills.\n\nKey tech: ASP.NET, PHP, JavaScript, HTML/CSS, MySQL.",
    crystal: 1,
    color: "#9fe9ff",
    accent: "#3ec8f0",
  },
